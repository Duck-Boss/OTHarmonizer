...
from .tree import convert_to_zssNode
...
def TEDS(constructed_tree, ref_tree, root_node_name= "root"):
    ...
    constructed_tree_zss = constructed_tree
    ref_tree_zss = ref_tree
    constructed_tree_zss = convert_to_zssNode(constructed_tree_zss)
    ref_tree_zss = convert_to_zssNode(ref_tree_zss)

    
    dist_constructed_tree = zss.simple_distance(constructed_tree_zss, root_node)
    print("nodes of constructed_tree", dist_constructed_tree)
    dist_ref_tree = zss.simple_distance(ref_tree_zss, root_node)
    print("nodes of ref_tree", dist_ref_tree)
    
    dist = zss.simple_distance(constructed_tree_zss, ref_tree_zss)
    print("TED:", dist)
